...
import numpy as np
from graph_visualisation import network_visualisation
...
# Suppose `model` is your DBN or BayesianNetwork
network_visualisation(
    model,
    html_file="sepsis_dbn.html",
    notebook=False,        # True if in a Jupyter notebook
    physics="barnes_hut"  # or "force_atlas_2based"
)